...
<head>
    <meta charset="UTF-8">
    <title>Quiz: <?php echo e($filename); ?></title>
...
<body>
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="back">← Back to Dashboard</a>

    <div class="quiz-container">
        <h1 class="quiz-title">Quiz: <?php echo e($filename); ?></h1>
        ...
        <form method="POST" action="<?php echo e(route('quiz')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="file"     value="<?php echo e($filename); ?>">
            ...
            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="question-block" id="qblock-<?php echo e($index); ?>">
                    <div class="question-header">
                        <h2>Q<?php echo e($index + 1); ?>: <?php echo e($q['prompt']); ?></h2>
                        <button
                            type="button"
                            class="speak-button"
                            data-qindex="<?php echo e($index); ?>"
                        ...
                        <?php $__currentLoopData = $q['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter => $optText): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <input
                                    ...
                                    id="q<?php echo e($index); ?>_<?php echo e($letter); ?>"
                                    value="<?php echo e($letter); ?>">
                                <label for="q<?php echo e($index); ?>_<?php echo e($letter); ?>">
                                    <?php echo e($letter); ?>. <?php echo e($optText); ?>
...
<?php /**PATH D:\Laracast\NCK-helper\resources\views/quiz.blade.php ENDPATH**/ ?>