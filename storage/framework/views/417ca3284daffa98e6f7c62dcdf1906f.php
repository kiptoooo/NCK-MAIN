...
<nav>
    ...
    <div class="top-actions">
        <div class="status">
            Status:
            <?php if(Auth::check() && Auth::user()->is_subscribed): ?>
        ...
        <div class="actions">
            <a href="<?php echo e(route('dashboard')); ?>">🏠 Back to Dashboard</a>
...
<?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionLabel => $relativeDiskFolder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section">
        <h2><?php echo e($sectionLabel); ?></h2>
        <?php
            $subfolders = Storage::disk('public')->directories($relativeDiskFolder);
        ?>
        <div class="category-grid">
        <?php $__empty_1 = true; $__currentLoopData = $subfolders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subfolderPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="category">
                <div class="category-controls">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.delete')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="path" value="<?php echo e($subfolderPath); ?>">
                        <button type="submit"
                            onclick="return confirm('Delete entire category “<?php echo e($categoryName); ?>” and its files?')"
                        >🗑 Delete Category</button>
                    </form>
                </div>

                <form action="<?php echo e(route('admin.upload')); ?>" method="POST" enctype="multipart/form-data" class="upload-form">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="paper"    value="<?php echo e($paperKey); ?>">
                    <input type="hidden" name="category" value="<?php echo e($categoryName); ?>">
                    <label>
                        Upload files to <strong><?php echo e($categoryName); ?></strong>
                    </label><br>
                ...
                <div class="file-list">
                    <ul>
                        <?php $__empty_2 = true; $__currentLoopData = $filesInCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relativeFilePath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <?php
                                $filename  = basename($relativeFilePath);
                                $publicUrl = Storage::url($relativeFilePath);
                            ?>
                            <li>
                                <span class="filename"><?php echo e($filename); ?></span>
                                <div class="file-buttons">
                                    <a href="<?php echo e($publicUrl); ?>" class="view-link" target="_blank">
                                        ▶ View
                                    </a>
                                    <?php if(Auth::check() && Auth::user()->is_admin): ?>
                                        <form method="POST" action="<?php echo e(route('admin.delete')); ?>" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="path" value="<?php echo e($relativeFilePath); ?>">
                                            <button
                                                type="submit"
                                                onclick="return confirm('Delete <?php echo e($filename); ?>?')"
                                            >✖</button>
                                        </form>
                                    <?php endif; ?>
                                </div>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                            <li>No files uploaded in <?php echo e($categoryName); ?>.</li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p style="color:#94a3b8; margin-left:1rem;">
                No categories found in <?php echo e($sectionLabel); ?>.
            </p>
        <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH D:\Laracast\NCK-helper\resources\views/admin/list.blade.php ENDPATH**/ ?>