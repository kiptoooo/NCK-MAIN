...
<body class="dark-mode">
    ...
    <nav>
        ...
        <div class="actions">
            <?php if(Auth::user()->is_admin): ?>
                <a href="<?php echo e(route('admin.files')); ?>" class="manage">
    ...
    <div class="sections-wrapper">
        ...
        <div class="section">
            ...
            <div class="card-grid">
                <?php $__currentLoopData = $paper1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $listId   = 'list-p1-' . Str::slug($categoryName, '-');
                        $iconHtml = $iconMap[$categoryName] ?? $defaultIcon;
                    ?>

                    <div class="card" data-list-id="<?php echo e($listId); ?>" data-category="<?php echo e(strtolower($categoryName)); ?>">
                        <?php echo $iconHtml; ?>

                        <div class="card-label"><?php echo e($categoryName); ?></div>
                        <div class="card-sub">Click to expand</div>

                        <div class="file-list" id="<?php echo e($listId); ?>">
                                            ...
                                            <div class="file-buttons">
                                                ...
                                                <?php if(Auth::user()->is_admin): ?>
                                                    <form method="POST"
                                                        ...
                                                        <input type="hidden"
                                                               name="path"
                                                               value="<?php echo e('nck/paper_1/' . $categoryName . '/' . $filename); ?>">
                                                        <button type="submit"
                                                                class="delete-link"
        ...
        <div class="section">
            ...
            <div class="card-grid">
                <?php $__currentLoopData = $paper2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                                            ...
                                            <div class="file-buttons">
                                                ...
                                                <?php if(Auth::user()->is_admin): ?>
                                                    <form method="POST"
                                                        ...
                                                        <input type="hidden"
                                                               name="path"
                                                               value="<?php echo e('nck/paper_2/' . $categoryName . '/' . $filename); ?>">
                                                        <button type="submit"
                                                                class="delete-link"
                                                                onclick="return confirm('Delete &quot;<?php echo e($filename); ?>&quot;?')">
                                                            ✖
        ...
        <div class="section">
            ...
            <div class="card-grid">
                <?php $__currentLoopData = $pastpapers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                                            ...
                                            <div class="file-buttons">
                                                ...
                                                <?php if(Auth::user()->is_admin): ?>
                                                    <form method="POST"
                                                        ...
                                                        <input type="hidden"
                                                               name="path"
                                                               value="<?php echo e('nck/pastpapers/' . $categoryName . '/' . $filename); ?>">
                                                        <button type="submit"
                                                                class="delete-link"
                                                                onclick="return confirm('Delete &quot;<?php echo e($filename); ?>&quot;?')">
                                                            ✖
        ...
        <div class="section">
            ...
            <div class="card-grid">
                <?php $__currentLoopData = $predictions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                                            ...
                                            <div class="file-buttons">
                                                ...
                                                <?php if(Auth::user()->is_admin): ?>
                                                    <form method="POST"
                                                        ...
                                                        <input type="hidden"
                                                               name="path"
                                                               value="<?php echo e('nck/predictions/' . $categoryName . '/' . $filename); ?>">
                                                        <button type="submit"
                                                                class="delete-link"
                                                                onclick="return confirm('Delete &quot;<?php echo e($filename); ?>&quot;?')">
                                                            ✖
    ...
    <?php echo $__env->make('partials.peer-chat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
<?php /**PATH D:\Laracast\NCK-helper\resources\views/dashboard.blade.php ENDPATH**/ ?>