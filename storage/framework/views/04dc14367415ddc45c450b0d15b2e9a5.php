...
<head>
    ...
    <style>
        ...
        .speak-btn:active, .pause-btn:active {
...
<body>
    ...
    <h1><strong style="color: gold;"><?php echo e($filename); ?></strong></h1>
    <div class="toolbar">
    ...
    <div id="docx-container">
        <?php echo str_replace(['&nbsp;', 'PHPWord'], ['', ''], $html); ?>
...
<?php /**PATH D:\Laracast\NCK-helper\resources\views/docx_render.blade.php ENDPATH**/ ?>