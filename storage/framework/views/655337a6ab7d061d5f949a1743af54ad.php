...
<head>
    <meta charset="UTF-8">
    <title>Quiz Results: <?php echo e($filename); ?></title>
...
<body data-theme="dark">
    <nav>
        <div><a href="<?php echo e(route('dashboard')); ?>" class="back"><i class="fas fa-arrow-left"></i> Dashboard</a></div>
        <div class="controls">
    ...
    <h1>Quiz Results: <?php echo e($filename); ?></h1>
    ...
    <div class="grade-banner <?php echo e($gradeClass); ?>">
        <?php if($gradeClass === 'excellent'): ?><i class="fas fa-trophy trophy"></i><?php endif; ?>
        <h2><?php echo e($message); ?></h2>
        <p>You scored <strong><?php echo e($scorePercent); ?>%</strong>.</p>
    </div>
    ...
    <div class="gauge-container">
        ...
        <div class="gauge-text"><?php echo e($scorePercent); ?>%</div>
    </div>

    <div class="score-container">
        <h2><?php echo e($correctCount); ?> / <?php echo e($total); ?></h2>
        <p>Overall Correct Answers</p>
    </div>

    <?php $__currentLoopData = $feedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $fb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $blockClass = $fb['isCorrect'] ? '' : ($fb['isCorrect']===false ? 'incorrect': '');
            $delayMs    = 0.8 + ($idx * 0.1);
        ?>
        <div class="feedback-block <?php echo e($blockClass); ?>" style="animation-delay: <?php echo e($delayMs); ?>s;">
            <div class="question-prompt">Q<?php echo e($idx + 1); ?>: <?php echo e($fb['prompt']); ?></div>
            <ul>
                <?php $__currentLoopData = ['A','B','C','D']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="<?php echo e($liClass); ?>">
                        <strong><?php echo e($opt); ?>.</strong> <?php echo e($text); ?>

                        <?php if($correct): ?> <em>(Correct)</em>
                        <?php elseif($chosen): ?> <em>(Your choice)</em>
                        <?php endif; ?>
                    </li>
    ...
    <script>
        ...
        document.getElementById('download').addEventListener('click', () => {
            ...
            doc.setFontSize(16);
            doc.text(`Quiz: <?php echo e($filename); ?>`, 10,20);
            doc.setFontSize(14);
            doc.text(`Score: <?php echo e($scorePercent); ?>%`,10,30);
            doc.save(`<?php echo e($filename); ?>_Results.pdf`);
        });
        // Share to Twitter
        document.getElementById('share').addEventListener('click', () => {
            const url=encodeURIComponent(location.href);
            window.open(`https://twitter.com/intent/tweet?url=${url}&text=${encodeURIComponent(`I scored <?php echo e($scorePercent); ?>% on <?php echo e($filename); ?>!`)}`, '_blank');
        });
        // Particles
...
<?php /**PATH D:\Laracast\NCK-helper\resources\views/quiz_results.blade.php ENDPATH**/ ?>